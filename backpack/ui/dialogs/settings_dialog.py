...
class SettingsDialog(QDialog):
    ...
    def _build_general_tab(self) -> QWidget:
        ...
        layout_v = QVBoxLayout(layout_box)
        self.keep_panels_check = QCheckBox("Keep panels after close")
        self.keep_panels_check.setChecked(self.settings.keep_panels)
        self.keep_panels_check.setToolTip(
            "Remember the panel arrangement and restore it next launch.\n"
            "When off, the app opens with the default layout each time."
        )
        layout_v.addWidget(self.keep_panels_check)
        v.addWidget(layout_box)
    ...
    def _save(self):
        ...
        self.settings.keep_panels         = self.keep_panels_check.isChecked()
