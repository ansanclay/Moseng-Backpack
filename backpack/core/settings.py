...
class AppSettings:
    ...
    keep_panels: bool = True      # restore the panel layout on next launch
    panel_objects: list = field(default_factory=list)  # dock objectNames to recreate
    node_edges: list = field(default_factory=list)      # [[src, dst, port], …] wiring
